...
And here we go: [a native SwiftUI Apple Watch app](https://github.com/neonwatty/liars-dice) - a dice probability calculator that transforms gut instincts into more calculated decisions. 
