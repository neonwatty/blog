...
But then this starts to happen regularly:

![Wispr Flow producing broken garbage output and an argument validation error](/images/posts/wispr-flow-not-working/wispr-flow-garbage-output.png)
