...
export const metadata: Metadata = {
  title: 'Welcome! You\'re Subscribed',
  description: 'Your subscription is confirmed. Thanks for joining!',
  robots: {
    index: false,
    follow: false,
  },
        ...
        <div className="max-w-3xl mx-auto px-4 py-20">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl leading-relaxed mb-8 max-w-2xl mx-auto"
              ...
              Thanks for confirming your subscription! You'll receive updates on new releases,
              product improvements, and lessons from building in public.
            </p>
          </div>
          ...
          <div className="mb-16 p-8 rounded-2xl transition-all duration-300"
            ...
            <div className="mt-8 text-center">
              <p className="text-sm"
                ...
                Expect to hear from me when I have something worth sharing — no spam, no fluff.
              </p>
            </div>
          </div>
          ...
          <div className="text-center p-8 rounded-2xl transition-all duration-300"
            ...
            <p className="mb-6"
               style={{ color: 'var(--color-text-secondary)' }}>
              Follow along on social media for daily updates and behind-the-scenes
            </p>
