            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 p-8 rounded-2xl transition-all duration-300"
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start gap-4"
                  ...
                  <a href="https://www.youtube.com/@neonwatty" target="_blank" rel="noopener noreferrer"
                     className="hover:opacity-70 transition-opacity" title="YouTube">
                  ...
                  <a href="https://www.producthunt.com/@neonwatty" target="_blank" rel="noopener noreferrer"
                     className="hover:opacity-70 transition-opacity" title="Product Hunt">
                    <svg className="w-6 h-6" fill="#DA552F" viewBox="0 0 24 24">
                      <path d="M13.604 8.4h-3.405V12h3.405a1.8 1.8 0 0 0 0-3.6M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0m1.604 14.4h-3.405V18H7.2V6h6.404a4.8 4.8 0 1 1 0 9.6"/>
                    </svg>
                  </a>
                </div>
              </div>
