        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12 text-center">
              <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Slideshows</h1>
            </div>
                ...
                >
                  ...
                  <div className="h-48 bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center">
                    <div className="text-white text-center p-6">
                      <div className="text-3xl font-bold mb-2">{slideshow.metadata.totalSlides}</div>
            ...
            {slideshows.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-medium text-gray-900 dark:text-gray-100 mb-2">No slideshows yet</h3>
