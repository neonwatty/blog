...
export const metadata: Metadata = {
  ...
  description:
    "Follow the treasure map through GoDaddy's customer service cancellation flow - an interactive visual journey",
  openGraph: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4">
        <TreasureMap images={godaddyImages} paths={svgPaths} title="START HERE" />
      </div>
